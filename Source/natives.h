...
namespace ENTITY
{
	...
	static void _SET_ENTITY_HEALTH(Entity entity, int health, Any p2) { invoke<Void>(0xAC2767ED8BDFAB15, entity, health, p2); } // 0xAC2767ED8BDFAB15 b1207
...
namespace FIRE
{
	...
	static void ADD_EXPLOSION(float x, float y, float z, int explosionType, float damageScale, BOOL isAudible, BOOL isInvisible, float cameraShake) { invoke<Void>(0x7D6F58F69DA92530, x, y, z, explosionType, damageScale, isAudible, isInvisible, cameraShake); } // 0x7D6F58F69DA92530 b1207
...
namespace HUD
{
	...
	static Any _UIPROMPT_CREATE(Hash inputHash, const char* p1, Any p2, Any p3, Any p4, int p5) { return invoke<Any>(0x29FA7910726C3889, inputHash, p1, p2, p3, p4, p5); } // 0x29FA7910726C3889 b1207
...
namespace MISC
{
	...
	static void SET_WEATHER_TYPE(Hash weatherHash, BOOL p1, BOOL p2, BOOL overrideNetwork, float transitionTime, BOOL p5) { invoke<Void>(0x59174F1AFE095B5A, weatherHash, p1, p2, overrideNetwork, transitionTime, p5); } // 0x59174F1AFE095B5A b1207
	...
	static BOOL GET_GROUND_Z_FOR_3D_COORD(float x, float y, float z, float* groundZ, BOOL considerWaterAsGround) { return invoke<BOOL>(0x24FA4267BB8D2431, x, y, z, groundZ, considerWaterAsGround); } // 0x24FA4267BB8D2431 b1207
...
namespace NETWORK
{
	...
	static void NETWORK_OVERRIDE_CLOCK_TIME(int hour, int minute, int second, int transitionTime, BOOL FreezeTime) { invoke<Void>(0x669E223E64B1903C, hour, minute, second, transitionTime, FreezeTime); } // 0x669E223E64B1903C b1207
...
namespace PED
{
	static Ped CREATE_PED(Hash modelHash, float x, float y, float z, float heading, bool isNetwork, bool thisScriptCheck, bool p7, bool p8, bool p9, bool p10) {return invoke<Ped>(0xD49F9B0955C367DE, modelHash, x, y, z, heading, isNetwork, thisScriptCheck, p7, p8, p9, p10);} // 0xD49F9B0955C367DE b1207
	...
	static Ped CREATE_PED_ON_MOUNT(Ped Mount, Hash modelHash, int index, BOOL p3, BOOL p4, BOOL p5, BOOL p6) { return invoke<Any>(0xF89AA2BD01FC06B7, Mount, modelHash, index, p3, p4, p5, p6); } // 0xF89AA2BD01FC06B7 b1207
	static BOOL _IS_MOUNT_SEAT_FREE(Ped Mount, int Seat) { return invoke<Any>(0xAAB0FE202E9FC9F0, Mount, Seat); } // 0xAAB0FE202E9FC9F0 b1207
	...
	static void SET_PED_VISIBLE(Ped Ped, bool p1) { invoke<Void>(0x283978A15512B2FE, Ped, p1); } // 0x283978A15512B2FE b1207
	...
	static float _GET_PED_MAX_STAMINA(Ped ped) { return invoke<Any>(0xCB42AFE2B613EE55, ped); } // 0xCB42AFE2B613EE55 b1207
	static void _0x36513AFFC703C60D(Any p0) { invoke<Void>(0x36513AFFC703C60D, p0); } // 0x36513AFFC703C60D b1207
	static void _RESTORE_PED_STAMINA(Ped ped, float stamina) { invoke<Void>(0x675680D089BFA21F, ped, stamina); } // 0x675680D089BFA21F b1207
...
namespace PLAYER
{
	...
	static void RESTORE_SPECIAL_ABILITY(Any p0, Any p1, Any p2) { invoke<Void>(0x1D77B47AFA584E90, p0, p1, p2); } // 0x1D77B47AFA584E90 b1207
...
namespace UILOG
{
	...
	static void _LOG_SET_CACHED_OBJECTIVE(const char* p0) { invoke<Void>(0xFA233F8FE190514C, p0); } // 0xFA233F8FE190514C b1207
...
namespace VEHICLE
{
	...
	static Vehicle _CREATE_VEHICLE_2(Hash modelHash, float x, float y, float z, float heading, BOOL p5, BOOL p6, BOOL p7, BOOL p8, BOOL p9) { return invoke<Any>(0x214651FB1DFEBA89, modelHash, x, y, z, heading, p5, p6, p7, p8, p9); } // 0x214651FB1DFEBA89 b1207
...
namespace WEAPON
{
	...
	static void _GIVE_AMMO_TO_PED(Ped ped, Any p1, Any p2, Any p3) { invoke<Void>(0x106A811C6D3035F3, ped, p1, p2, p3); } // 0x106A811C6D3035F3 b1207
	...
	static void _SET_PED_INFINITE_AMMO_CLIP(Any p0, Any p1) { invoke<Void>(0xFBAA1E06B6BCA741, p0, p1); } // 0xFBAA1E06B6BCA741 b1207
	...
	static BOOL GET_MAX_AMMO(Ped ped, Any Ammo, Hash weaponHash) { return invoke<BOOL>(0xDC16122C7A20C933, ped, Ammo, weaponHash); } // 0xDC16122C7A20C933 b1207
	...
	static BOOL _GIVE_WEAPON_TO_PED(Ped ped, Hash WeaponName, int AmmoCount, BOOL p0, BOOL p1, BOOL p2, float Condition) { return invoke<Any>(0x5E3BDDBCB83F3D84, ped, WeaponName, AmmoCount, p0, p1, p2, Condition); } // 0x5E3BDDBCB83F3D84 b1207
	...
	static Any _HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(Entity entity, Hash weaponName, int weaponType) { return invoke<Any>(0xDCF06D0CDFF68424, entity, weaponName, weaponType); } // 0xDCF06D0CDFF68424 b1207
	...
	static void _REMOVE_WEAPON_COMPONENT_FROM_PED(Ped ped, Hash componentHash, Hash weaponHash) { invoke<Void>(0x19F70C4D80494FF8, ped, componentHash, weaponHash); } // 0x19F70C4D80494FF8 b1207
	static Any _HAS_PED_GOT_WEAPON_COMPONENT(Ped ped, Hash componentHash, Hash weaponHash) { return invoke<Any>(0xBBC67A6F965C688A, ped, componentHash, weaponHash); } // 0xBBC67A6F965C688A b1207
